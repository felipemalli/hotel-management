    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("OPEN", "Em aberto"), ("CLOSED", "Fechada"), ("PAID", "Paga")],
                        default="OPEN",
                        max_length=6,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.DecimalField(decimal_places=4, default=Decimal("1"), max_digits=7),
                ),
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("unit_amount__gte", 0), ("amount__gte", 0)),
                        name="accountline_money_non_negative",
                    ),
                    models.UniqueConstraint(
                        condition=models.Q(("kind__in", ["DAILY", "PARKING"])),
                        fields=("account", "kind", "service_date"),
                        name="accountline_one_per_kind_date",
                    ),
                    models.UniqueConstraint(
                        condition=models.Q(("kind", "LATE_FEE")),
                        fields=("account",),
