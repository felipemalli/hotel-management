...
- Checkout antecipado permitido mediante aprovação do atendente;
- Valores fixos, taxas e horários de check-in e check-out são imutáveis, mas podem ser substituídos via sistema de snapshot;
- A fatura final é gerada com base no shapshot dos valores e taxas do momento da reserva;
