...
const BASE: Reservation = {
  ...
  guest_id: ANA.id,
  companions: [],
  room: { id: ROOM_101.id, number: ROOM_101.number, capacity: ROOM_101.capacity },
  policy_id: null,
...
export const BRUNO_CHECKED_IN = reservation({
  ...
  room: { id: ROOM_102.id, number: ROOM_102.number, capacity: ROOM_102.capacity },
  policy_id: 1,
...
export const CARLA_CHECKED_OUT = reservation({
  id: 3,
  guest_id: CARLA.id,
  room: { id: ROOM_103.id, number: ROOM_103.number, capacity: ROOM_103.capacity },
  policy_id: 1,
